package com.fileManager.common.util.log4j;
...
public class FormatHTMLLayout extends HTMLLayout {
	...
	public String format(LoggingEvent event) {
		...
		sbuf.append("<td>");
		sbuf.append(new SimpleDateFormat("MM-dd HH:mm:ss")
	...
	public String getHeader() {
		...
		sbuf.append("<!--" + Layout.LINE_SEP);
		sbuf.append("body, table {font-family: 'Microsoft Yahei',arial,sans-serif; font-size: 12px;}"
				+ Layout.LINE_SEP);
		sbuf.append("th {background: #5eb95e; color: #FFFFFF; text-align: left;}"
				+ Layout.LINE_SEP);
		sbuf.append("-->" + Layout.LINE_SEP);
